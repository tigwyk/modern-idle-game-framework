...
const canAfford = computed(() => props.generator.canPurchase(resourceMap.value, 1))

const maxAffordable = computed(() => props.generator.getMaxAffordable(resourceMap.value))
...
const ownedAriaLabel = computed(() => `Owned ${props.generator.purchased} ${props.generator.name}`)
...
const buyTenAriaLabel = computed(() => `Purchase 10 ${props.generator.name}s`)

const buyHundredAriaLabel = computed(() => `Purchase 100 ${props.generator.name}s`)
